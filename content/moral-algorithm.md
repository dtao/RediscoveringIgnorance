...
Maybe it doesn't. Maybe morality is less like a compass and more like an algorithm---a set of processes that respond to inputs and generate outputs, without a preset destination.
...
Viewed this way, the thought experiments of Harris and Parfit look less like logical puzzles and more like artificial physical configurations, the kind you get when you press two magnets together north-to-north. Such states don't arise naturally. But understanding how the forces work lets us predict what happens if they do: the magnets repel each other and spring apart the moment you let go. A world of maximal suffering might drive its conscious beings, at every level, to end that suffering. A world of barely-living multitudes might see them urgently compelled toward finding a better life, disinterested in reproduction. Or something else---it would depend on the tuning of the algorithm's parameters, which we may not be able to precisely measure.

To be clear, I am not making a bold claim about what morality fundamentally *is*. It may be something else entirely---divine, emergent, illusory. But thinking of it as an algorithm rather than a compass offers, to me, a way around some of the seemingly impossible questions on the subject. As with any change of lens, it may not reveal the ultimate truth (as every lens bends the light), but it can bring into focus something that was previously unclear.
