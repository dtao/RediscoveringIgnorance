...
Which is why I think the question "will my job be automated?" is the wrong question to ask. If you believe your job is reducible to a set of tasks, then the answer is yes---because tasks get automated. But even if that's what your job is, is that what _you_ are---are you a set of tasks?
